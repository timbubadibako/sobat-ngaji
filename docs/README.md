...
Dokumen ini adalah source truth untuk product, design, architecture, dan coding rules Sobat Ngaji.
...
Gunakan `BackendRequirements.md` sebagai dokumen kebutuhan backend lengkap. Dokumen ini memperluas `API.md`, `APISequence.md`, `BackendArchitecture.md`, dan `Database.md` dengan endpoint, realtime WebSocket, upload audio, model data, security, dan acceptance criteria backend.

## Development Principle

Jangan coding dari screen. Coding dari feature. Jangan memberi agent semua dokumen sekaligus. Gunakan `ContextStrategy.md` untuk memilih dokumen per sprint.
